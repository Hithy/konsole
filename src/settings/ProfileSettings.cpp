...
ShortcutItemDelegate2::ShortcutItemDelegate2(QObject* aParent)
    : QStyledItemDelegate(aParent)
{
}
void ShortcutItemDelegate2::editorModified(const QKeySequence& keys)
{
    Q_UNUSED(keys);
...
void ShortcutItemDelegate2::setModelData(QWidget* editor, QAbstractItemModel* model,
...
QWidget* ShortcutItemDelegate2::createEditor(QWidget* aParent, const QStyleOptionViewItem&, const QModelIndex& index) const
{
    ...
    connect(editor, &KKeySequenceWidget::keySequenceChanged, this, &Konsole::ShortcutItemDelegate2::editorModified);
    editor->captureKeySequence();
    return editor;
}
void ShortcutItemDelegate2::paint(QPainter* painter, const QStyleOptionViewItem& option,
                                 const QModelIndex& index) const
{
